...
function hideToc() {
  ...
  tocdiv.innerHTML = '';
  var toclink = document.getElementById("toclink");
  toclink.innerHTML = '<a href="#" onclick="scroll(0,0); showToc(); Effect.toggle('+"'toc-result','blind');"+'">» Show Table of Contents</a> <img src="http://3.bp.blogspot.com/-ZMvD8xkIrx8/VBpj7M0TNzI/AAAAAAAADFg/G6CcaB5XBkA/s1600/new.gif"/>';
}